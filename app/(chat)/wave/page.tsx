            ...
            sortedHistory.map((track) => (
              <article className="rounded-xl border border-border/50 bg-background/60 p-3" key={track.id}>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  {track.audioUrl ? <a className="inline-flex" download href={track.audioUrl}><Button size="sm" variant="outline"><Download className="mr-1 size-4" />Télécharger</Button></a> : null}
                </div>
              </article>
            ))
          )}
