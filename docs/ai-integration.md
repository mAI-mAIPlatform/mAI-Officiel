...
- **Modèles** : La définition des modèles est centralisée dans `lib/ai/models.ts`. On y trouve des modèles économiques (dont **OpenRouter** et **Ollama**) pour le chat, et un modèle spécifique pour générer des titres (`openai/gpt-5-nano`).
